...
/obj/item/tool/pickaxe/plasmacutter/equipped(mob/user, slot) //bump attack activate
	. = ..()
	toggle_item_bump_attack(user, TRUE)

/obj/item/tool/pickaxe/plasmacutter/dropped(mob/user) //bump attack deactivate
	. = ..()
